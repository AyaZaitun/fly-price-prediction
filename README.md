...
FlyPrice AI is a full-stack flight price prediction web application that uses a pre-trained regression pipeline to estimate ticket prices from user travel details.
...
The backend loads a pre-trained pipeline saved under `backend/model/`.

The current pipeline includes:

- feature preprocessing
- categorical encoding for cities, times, stops, and class
- a trained XGBoost regressor for price prediction
